...
class Inception3(nn.Module):
    ...
    def _forward(self, x: Tensor, mask: Optional[Tensor]=None, return_features: bool=False, back: bool=False) -> Tuple[Tensor, Optional[Tensor]]:
        # N x 3 x 299 x 299
    ...
    def forward(self, x: Tensor, mask: Optional[Tensor]=None, return_features: bool=False, back: bool=False) -> InceptionOutputs:
        x = self._transform_input(x)
        if return_features:
            return self._forward(x, mask=mask, return_features=True, back=back)
        out1, out2, aux1, aux2 = self._forward(x, mask=mask, return_features=False, back=back)
